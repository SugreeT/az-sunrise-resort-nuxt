  ...
  <main>
    <div class="hero full-height jarallax" data-jarallax data-speed="0.2">
      <client-only>
        <img
          class="jarallax-img"
          src="~assets/img/banner/spa/spa4.jpg"
          alt=""
        />
        <div
    ...
    <div class="container margin_120_95" id="first_section">
      <div class="row justify-content-between align-items-center">
        <div class="col-lg-5">
          <div class="intro">
            <div class="title">
              <h2 data-cue="slideInLeft" data-duration="1000">
                {{ $t("spa.title") }}
              </h2>
            </div>
          ...
          <div>
            <ul class="list-unstyled mb-4">
              ...
              <li
                ...
                data-duration="2000"
              >
                <strong>{{ $t("spa.signature") }}</strong>
                <span>{{ $t("spa.time.signature") }}</span>
              </li>
              <li
                class="d-flex justify-content-between mb-2 text-end"
                data-cue="slideInRight"
      ...
      <div class="container-fluid p-lg-0">
        <div data-cues="zoomIn">
          ...
          >
            ...
            <div class="item">
              <img
                src="https://azsunriseresort.com/images/Spa/AZ Spa_1-topaz.jpg"
                alt=""
              />
            </div>
            <div class="item">
              <img
                src="https://azsunriseresort.com/images/Spa/AZ Spa_2-topaz.jpg"
                alt=""
              />
            </div>
            <div class="item">
            ...
            <div class="item">
              <img
                src="https://azsunriseresort.com/images/Spa/AZ Spa_6-topaz.jpg"
                alt=""
              />
            </div>
            <div class="item">
              <img
                src="https://azsunriseresort.com/images/Spa/AZ Spa_7-topaz.jpg"
                alt=""
              />
            </div>
            <div class="item">
              <img
                src="https://azsunriseresort.com/images/Spa/AZ Spa_8-topaz.jpg"
                alt=""
              />
            </div>
          </div>
        ...
        <div class="text-center mt-5">
          <a
            ...
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_1-topaz.jpg"
            >{{ $t("gallery.fullscreen") }}</a
          >
          <a
            data-fslightbox="gallery_1"
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_2-topaz.jpg"
          ></a>
          <a
            data-fslightbox="gallery_1"
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_3-topaz.jpg"
          ></a>
          <a
            data-fslightbox="gallery_1"
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_4-topaz.jpg"
          ></a>
          <a
            data-fslightbox="gallery_1"
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_5-topaz.jpg"
          ></a>
          <a
            data-fslightbox="gallery_1"
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_6-topaz.jpg"
          ></a>
          <a
            data-fslightbox="gallery_1"
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_7-topaz.jpg"
          ></a>
          <a
            data-fslightbox="gallery_1"
            data-type="image"
            href="https://azsunriseresort.com/images/Spa/AZ Spa_8-topaz.jpg"
          ></a>
        </div>
      </div>
    </div>
    ...
    <div class="pinned-image pinned-image--medium pt-3">
      <div class="pinned-image__container" id="section_video">
        <video loop="loop" muted="muted" id="video_home">
          ...
          />
          <source
            src="https://azsunriseresort.com/video/swimming_pool_2a.webm"
            type="video/webm"
          />
          <source
            src="https://azsunriseresort.com/video/swimming_pool_2.ogv"
            type="video/ogg"
          />
        </video>
