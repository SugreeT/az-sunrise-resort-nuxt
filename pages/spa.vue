              ...
              <div class="col-lg-5">
                  <div class="intro">
                      <div class="title">
                          ...
                          <h2 data-cue="slideInLeft"  data-duration="1000"> Spa Center </h2>
                      </div>
                      <p class="lead" data-cue="slideInLeft" data-duration="1500">Immerse yourself in a world of tranquility and rejuvenation at our luxurious hotel spa. Indulge in soothing treatments designed to revitalize your body and calm your mind. From rejuvenating massages to personalized skincare rituals, every moment is tailored for your well-being.                    </p>
                      <p >Let our expert therapists guide you on a journey of relaxation amidst a serene and elegant setting, ensuring an experience of true bliss.</p>
                ...
                <div>
                    <ul class="list-unstyled mb-4">
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong> Opening Hours</strong> <span>9.00am – 8.00pm</span>
                        </li>
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>Signature Massage</strong> <span>10.00am – 6.00pm  (By Appointment)</span>
                        </li>
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>Evening Relaxation Ritual</strong> <span>6.30pm – 9.00pm</span>
                        </li>
                    </ul>
