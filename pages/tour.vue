<template>
  <main>
        ...
        <div class="hero full-height jarallax" data-jarallax data-speed="0.2">
            <client-only>
                <img class="jarallax-img" src="~assets/img/bg_img/tour1.jpg" alt="">
                        ...
                        <div class="row justify-content-center justify-content-md-start">
                            <div class="col-lg-6 static">
                                <div class="slide-text white">
                                    <small class="slide-animated one">{{ $t('experience.tour') }}</small>
        ...
        <div class="container margin_120_95" id="first_section">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="intro">
                    <div class="title">
                    <h2 data-cue="slideInLeft" data-duration="1000">{{ $t('tour.title') }}</h2>
                    </div>
                ...
                <div>
                    ...
                    <li class="d-flex justify-content-between mb-2 text-end" data-cue="slideInRight" data-duration="2000">
                        <strong>{{ $t('tour.morning') }}</strong>
                        <span>{{ $t('tour.time.morning') }}</span>
                    </li>
                    <li class="d-flex justify-content-between mb-2 text-end" data-cue="slideInRight" data-duration="2000">
                        <strong>{{ $t('tour.afternoon') }}</strong>
                        <span>{{ $t('tour.time.afternoon') }}</span>
                    </li>
                    <li class="d-flex justify-content-between mb-2 text-end" data-cue="slideInRight" data-duration="2000">
                        <strong>{{ $t('tour.evening') }}</strong>
                        <span>{{ $t('tour.time.evening') }}</span>
                    </li>
                    </ul>
