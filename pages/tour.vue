  ...
  <main>
        <div id="carousel-home">
            <div class="owl-carousel owl-theme kenburns">
                <div class="owl-slide background-image cover" data-background="url(img/bg_img/tour1.jpg)">
                    <div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <div class="container">
                            <div class="row justify-content-center justify-content-md-start">
                                <div class="col-lg-6 static">
                                    <div class="slide-text white">
                                        <small class="owl-slide-animated owl-slide-title">Tour Experience</small>
                ...
                <!--/owl-slide-->
                <div class="owl-slide background-image cover" data-background="url(img/bg_img/tour2.jpg)">
                    <div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <div class="container">
                ...
                <!--/owl-slide-->
                <div class="owl-slide background-image cover" data-background="url(img/bg_img/tour3.jpg)">
              ...
              <div class="col-lg-5">
                  <div class="intro">
                      <div class="title">
                          ...
                          <h2 data-cue="slideInLeft"  data-duration="1000"> Tour Center </h2>
                      </div>
                      <p class="lead" data-cue="slideInLeft" data-duration="1500">Embark on a journey to explore breathtaking landscapes and rich cultural heritage with our curated tours. Whether you're seeking a relaxing getaway or an adventurous excursion, our experienced guides ensure an unforgettable experience.</p>
                      <p >From scenic trails to vibrant local markets, every tour is designed to immerse you in the unique charm and beauty of the destination.</p>
                ...
                <div>
                    ...
                    <ul class="list-unstyled mb-4">
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>Morning Tour</strong> <span>8.00am – 12.00pm</span>
                        </li>
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>Afternoon Tour</strong> <span>1.00am – 5.00am</span>
                        </li>
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>Evening City Walk</strong> <span>6.30pm – 9.00pm</span>
                        </li>
                    </ul>
