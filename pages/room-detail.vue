<template>
  <main>
    <div class="hero full-height jarallax" data-jarallax data-speed="0.2">
      <client-only>
        <img class="jarallax-img" src="~assets/img/img_ex/1.jpg" alt="" />
        <div
...
<div class="hero full-height jarallax" data-jarallax data-speed="0.2">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-4">
            ...
            <p>
              ...
              four-poster bed, and magnificent black stone bathroom evoke the
              charm of a secluded Sierra Nevada getaway. The intimate scale and
              finish give the room a distinctly personal feel.
            </p>
            <p>
              The dark wood panelling and furnishings, deluxe red-draped
              four-poster bed, and magnificent black stone bathroom evoke the
    ...
    <div class="container margin_120_95" id="reviews" style="display: none">
      <div class="row justify-content-between">
            ...
            <div class="row">
              ...
              <div class="col-md-10 review_content">
                <div class="clearfix mb-3">
                  <span class="rating"
                    >8.5<small>/10</small> <strong>Rating average</strong></span
                  >
          ...
          <div class="review_card">
            <div class="row">
              ...
              <div class="col-md-10 review_content">
                <div class="clearfix mb-3">
                  <span class="rating"
                    >9.0<small>/10</small> <strong>Rating average</strong></span
                  >
            ...
            <div class="row reply">
              ...
              <div class="col-md-10">
                <div class="review_content">
                  ...
                  <p>
                    <br />Hi Monika,<br /><br />Eos tollit ancillae ea, lorem
                    consulatu qui ne, eu eros eirmod scaevola sea. Et nec tantas
                    accusamus salutatus, sit commodo veritus te, erat legere
                    fabulas has ut. Rebum laudem cum ea, ius essent fuisset ut.
                    Viderer petentium cu his. Tollit molestie suscipiantur his
                    et.<br /><br />Thanks
                  </p>
                </div>
              </div>
              ...
              <a href="rooms" class="box_cat_rooms">
                <figure>
                  <div
                    ...
                    data-background="url(img/rooms/1.jpg)"
                  ></div>
                  <div class="info">
        ...
        <div class="col-xl-7">
          <div data-cue="slideInUp" data-delay="200">
            ...
            <p class="text-end mt-5">
              <a href="#0" class="btn_1 outline">{{ $t("button") }}</a>
            </p>
          </div>
        </div>
        <!-- /col -->
...
export default {
  ...
  mounted() {
    //   this.roomName = localStorage.getItem('roomName') || 'Default Room';
    this.roomKey = localStorage.getItem("roomKey") || "room.standardDouble";
    setTimeout(() => {
