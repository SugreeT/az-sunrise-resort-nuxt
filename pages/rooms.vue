        ...
        <div class="col-xl-7">
          ...
          <!-- <div class="item">
                <a
                  ...
                  ><img src="~assets/img/banner/rooms/room1.jpg" alt=""
                /></a>
              </div>
              <div class="item">
                <a
          ...
          <!-- <div class="row_list_version_3" data-cue="fadeIn">
            ...
            >
              <div class="item">
                <a
                  @click="goToRoomDetail('room.standardTwin')"
                  style="cursor: pointer"
                  ><img src="~assets/img/banner/rooms/room3.jpg" alt=""
                /></a>
              </div>
              <div class="item">
                <a
          ...
          <div class="row_list_version_3" data-cue="fadeIn">
            ...
            >
              <div class="item">
                <a
                  @click="goToRoomDetail('room.deluxeDouble')"
                  style="cursor: pointer"
                  ><img src="~assets/img/banner/rooms/room1.jpg" alt=""
                /></a>
              </div>
          ...
          <div class="row_list_version_3" data-cue="fadeIn">
            ...
            >
              <div class="item">
                <a
                  @click="goToRoomDetail('room.deluxeTwin')"
                  style="cursor: pointer"
                  ><img src="~assets/img/banner/rooms/room3.jpg" alt=""
                /></a>
              </div>
          ...
          <div class="row_list_version_3" data-cue="fadeIn">
            ...
            >
              <div class="item">
                <a
                  @click="goToRoomDetail('room.family')"
                  style="cursor: pointer"
                  ><img src="~assets/img/banner/rooms/room1.jpg" alt=""
                /></a>
              </div>
