                        ...
                        <div class="row justify-content-center justify-content-md-start">
                            <div class="col-lg-6 static">
                                <div class="slide-text white">
                                    <small class="slide-animated one">{{ $t('experience.fitness') }}</small>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <li class="d-flex justify-content-between mb-2 text-end" data-cue="slideInRight" data-duration="2000">
                        <strong>{{ $t('fitness.hours_title') }}</strong> <span>{{ $t('fitness.hours_open') }}</span>
                    </li>
                    <li class="d-flex justify-content-between mb-2 text-end" data-cue="slideInRight" data-duration="2000">
                        <strong>{{ $t('fitness.yoga_class') }}</strong> <span>{{ $t('fitness.yoga_time') }}</span>
                    </li>
                    <li class="d-flex justify-content-between mb-2 text-end" data-cue="slideInRight" data-duration="2000">
                        <strong>{{ $t('fitness.hiit_class') }}</strong> <span>{{ $t('fitness.hiit_time') }}</span>
                    </li>
                    </ul>
