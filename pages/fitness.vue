    ...
    <main>
        <div id="carousel-home">
            <div class="owl-carousel owl-theme kenburns">
                <div class="owl-slide background-image cover" data-background="url(img/bg_img/fit1.jpg)">
                ...
                <!--/owl-slide-->
                <div class="owl-slide background-image cover" data-background="url(img/bg_img/fit2.jpg)">
                    <div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                        <div class="container">
                ...
                <!--/owl-slide-->
                <div class="owl-slide background-image cover" data-background="url(img/bg_img/fit3.jpg)">
              ...
              <div class="col-lg-5">
                  <div class="intro">
                      <div class="title">
                          ...
                          <h2 data-cue="slideInLeft"  data-duration="1000"> Fitness Center </h2>
                      </div>
                      <p class="lead" data-cue="slideInLeft" data-duration="1500">Discover the ultimate wellness experience at our state-of-the-art fitness center. Our facility is designed to cater to all fitness levels, offering a variety of modern equipment and classes that inspire and motivate. </p>
                      <!-- <p class="lead">Whether you're seeking an intense workout or a relaxing yoga session, our expert trainers are here to guide you every step of the way. Unwind in a space that blends health and luxury, designed to rejuvenate your mind and body. </p> -->
                      <p data-cue="slideInLeft" data-duration="2000"><em>Enjoy...the Owner</em></p>
                  </div>
              </div>
                ...
                <div>
                    <ul class="list-unstyled mb-4">
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>Opening Hours</strong> <span>7.00am – 10.00pm</span>
                        </li>
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>Yoga Class</strong> <span>8.00am – 9.00am</span>
                        </li>
                        <li class="d-flex justify-content-between mb-2 text-end"  data-cue="slideInRight" data-duration="2000">
                            <strong>HIIT Training</strong> <span>6.00pm – 7.00pm</span>
                        </li>
                    </ul>
